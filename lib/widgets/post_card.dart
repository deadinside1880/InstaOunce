...
import 'package:shron/screens/CommentsScreen.dart';
import 'package:shron/utils/colors.dart';
import 'package:shron/utils/util.dart';
import 'package:shron/widgets/like_animation.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
                              ...
                              children: ['delete']
                                  .map(
                                    (e) => Material(
                                      child: InkWell(
                                        onTap: () async {
                                          await FirestoreFunctions().deletePost(
                                              widget.snap['postId']);
          ...
          GestureDetector(
            onDoubleTap: () async {
              await FirestoreFunctions().likePost(
          ...
          Row(children: [
            LikeAnimation(
                ...
                smallLike: true,
                child: IconButton(
                    onPressed: () async => await FirestoreFunctions().likePost(
                        widget.snap['postId'], user.uid, widget.snap['likes']),
                    icon: Icon(
                      Icons.favorite,
